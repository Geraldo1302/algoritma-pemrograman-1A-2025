...
if masukan == "admin":
    ...
    while True:
        ...
        if pilihan == "buat akun baru":
            ...
            if not akun:
                print("Anda masih belum memiliki akun, silakan membuat terlebih dahulu.")
                buat_akun()
                print("====== MASUKKAN USERNAME DAN PASSWORD ======")

        while kesempatan > 0:
            print(f"kesempatan login anda sebanyak {kesempatan}")
        ...
        if kesempatan == 0:
            print(" Login gagal 3 kali! Akses diblokir.")
            exit()
